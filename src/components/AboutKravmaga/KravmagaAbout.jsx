        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2">
              <h1 className="text-[#ececec] font-bold text-3xl">{section.title_krav[language]}</h1>
          ...
          <div className="text-center md:text-left">
            <h1 className="text-[#ececec] font-bold text-3xl">{section.title_federation[language]}</h1>
            <p className="mt-4 text-[16px] text-[#bfbfbf] leading-relaxed">
